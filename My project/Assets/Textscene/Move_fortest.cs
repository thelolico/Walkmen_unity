...
public class Move_fortest : MonoBehaviour
{
    private Rigidbody myRigidbody;
    [SerializeField] float movespeed = 20f,movespeed_R = 30f,jumphigher = 100f,jumptime = 100f,maxjumptime = 100f;
    [SerializeField] float tp_x = 8436.244f,tp_y =  -18210f,tp_z = 17541.88f;
    [SerializeField] float limit_Y = -19000f;
    ...
    void Start()
    {
        ...
        //transform.position = new Vector3(28,198,-1277);
    }
    ...
    void Update()
    {
        ...
        if(Input.GetKey(KeyCode.P) || pos <= limit_Y)
        {
